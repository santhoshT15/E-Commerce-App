...
const Login = () => {
  ...
  return (
    <form onSubmit={submitHandler} className='flex flex-col items-center w-[30%] sm:msx-w-96 m-auto mt-14 gap-4 text-gray-800'>
      ...
      <input type="email" onChange={(e) => setEmail(e.target.value)} value={email} className='w-full px-3 py-2 border border-gray-800' placeholder='Email Address' required/>
